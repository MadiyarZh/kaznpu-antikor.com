    ...
    if($numrows!=0) {
        ...
        while($row=mysqli_fetch_assoc($query)) {
            ...
            <tr>
                ...
                <td>
                    <a href="../uploads/documents/<?echo $row['path_file']?>" target="_black"><?echo $row['nameRu']?><a>
                </td>
                <td>
                    <a href="../uploads/documents/<?echo $row['path_file']?>" target="_black"><?echo $row['nameKaz']?><a>
                </td>
                <td style="text-align:center;">
                    <a href="update.php?id=<? echo $row['id']?>" title="Редактировать"><i class="icon-pencil"></i></a>
                </td>
                <td style="text-align:center;">
                    <a href="vendor/delete.php?id=<? echo $row['id']?>" title="Удалить"><i class="icon-bin"></i></a>
                </td>
            </tr>
            <?
        }
